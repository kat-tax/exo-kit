import {useContext, useEffect, useState, useImperativeHandle, useRef, forwardRef, createContext} from 'react';
...
export const PdfProvider = forwardRef<PdfRef, Omit<PdfProviderProps, 'ref'>>(
  ({src, children, onPageChange}, ref) => {
