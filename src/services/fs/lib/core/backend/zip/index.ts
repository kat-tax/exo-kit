 ...
 */
export class ZipHfsImpl implements HfsImpl {
  /**
 ...
 */
export class ZipHfs extends Hfs implements HfsImpl {
  /** Creates a new instance. */
  constructor({root}: {root: typeof FileSystem}) {
    super({impl: new ZipHfsImpl({root})});
  }
}

export const mount = async () => new ZipHfs({
  root: FileSystem,
});