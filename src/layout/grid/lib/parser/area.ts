...
import type {GridViewItemData, GridViewColumnInfo, GridViewGaps, GridViewPosition} from '../../Grid.types';
 ...
 */
export function position(value: string): GridViewPosition {
