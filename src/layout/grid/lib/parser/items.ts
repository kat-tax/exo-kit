...
import type {GridViewItemData, GridViewItemOptions, GridViewPosition, GridViewItemStyle} from '../../Grid.types';
...
export function create(
  ...
  const id = `${rowStart}-${rowEnd}-${columnStart}-${columnEnd}`;
 ...
 */
export function move(gridItems: GridViewItemData[], maxColumns: number): void {
